...
//Click on show alert box
        driver.findElement(By.id("alertexamples")).click();//Bu tıklama sonrası alert box açılır.
        //JS Alert açık ikn sayfada işlem yapılamaz!!! --> UnhandledAlertException alırız.

//Print alert message on console
        String alertMessage = driver.switchTo().alert().getText(); //switch yapmamız lazım
