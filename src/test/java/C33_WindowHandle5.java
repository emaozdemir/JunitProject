...
//        driver.switchTo().window(windowHandles.get(1));//Driver'ı yeni açılan sayfaya götürür.
        ...
        driver.findElement(By.xpath("//input[@name='submitbutton']")).click();//NoSuchElementException almamak için açılan sayfaya driver'ı götürmeliyiz.(üst teki 1.yol yada 2.yolla yani)
