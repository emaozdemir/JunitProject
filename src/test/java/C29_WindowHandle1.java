...
*/
    ...
    public void windowHandleTest(){
        ...
        // Bu kod, bir WebDriver kullanarak bir tarayıcı penceresini açar
        // ve URL'si "about:blank" olan boş bir sayfayı yükler. Bu genellikle
        // tarayıcıda herhangi bir içerik olmayan bir pencere oluşturmak için kullanılır.
        //Open empty window
     ...
     //   driver.switchTo().newWindow(WindowType.TAB);//newWindow() metodu ile açılan yeni sayfaya driver otomatik olarak geçer.
        ...
        driver.switchTo().newWindow(WindowType.TAB);//ilk acılan pencerede yeni tab acıyor?
